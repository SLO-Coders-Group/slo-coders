    ...
    <>
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="A list of tech companies in San Luis Obispo county for all kinds of developers, engineers, and coders to find their perfect work home."
        />
        <link
          key="canonical"
          rel="canonical"
      ...
      <Layout page="tech-companies">
        ...
        >
          ...
          <Typography variant="body2">
            ...
            companies, or report a mistake, please{" "}
            <Link
